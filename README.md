...
The transmiting, output LED is lower right. The receiver sensor LED is lower center some what obstructed by the yellow wire.

### Waformes on POC
The Proof Of Concept measured with oscilliscope.  
...
### Example plot
Arduino IDE Serial Plot putput.  
